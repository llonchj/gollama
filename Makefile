...
CXXFLAGS = -I./llama.cpp -I. -I./llama.cpp/common -I./common -I./llama.cpp/ggml/include -I./llama.cpp/include -I./llama.cpp/vendor -I./llama.cpp/third_party -O3 -DNDEBUG -std=c++17 -fPIC
LDFLAGS  =
